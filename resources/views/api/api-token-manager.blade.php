                                ...
                                <div class="col-6">
                                    <div class="mb-3">
                                        <div class="form-check">
                                            <x-checkbox wire:model.live="createApiTokenForm.permissions" id="{{ 'create-'.$permission }}" :value="$permission"/>
            ...
            <div class="mt-2 row">
                @foreach (Laravel\Jetstream\Jetstream::$permissions as $permission)
                    <div class="col-6">
                        <div class="mb-3">
                            <div class="form-check">
                                <x-checkbox wire:model.live="updateApiTokenForm.permissions" id="{{ 'update-'.$permission }}" :value="$permission"/>
