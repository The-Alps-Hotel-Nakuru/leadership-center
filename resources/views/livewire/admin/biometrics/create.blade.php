<div>
    <x-slot:header>New Biometric Record</x-slot:header>

    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h5>Create a new Biometric Record for an Employee</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-12">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            <label for="biometric.reason" class="form-label">Biometric ID</label>
