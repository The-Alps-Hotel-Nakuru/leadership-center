<div>
    ...
    <div class="container-fluid">
        <div class="my-3 d-flex">
            <button class="btn btn-secondary ms-auto" wire:loading.attr="disabled" wire:target="downloadTemplate"
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        <tr class="">
                            ...
                            <td>KES {{ number_format($fine->amount_kes,2) }}</td>
                            <td>{{ $fine->reason }}</td>
                            <td class="d-flex flex-row justify-content-center">
                                <div class="flex-col m-1">
                                    <a href="{{ route('admin.fines.edit', $fine->id) }}" class="btn btn-secondary">
