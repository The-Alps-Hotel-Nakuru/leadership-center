    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h5>Edit The Employee's Details</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            ...
                            <input wire:model.live="employee.first_name" type="text" class="form-control"
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            ...
                            <input wire:model.live="employee.last_name" type="text" class="form-control" name="last_name"
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            <label for="email" class="form-label">Email Address<span
                                    class="text-danger">*</span></label>
                            <input wire:model.live="employee.email" type="email" class="form-control" name="email"
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            <label for="phone_number" class="form-label">Phone Number<span
                                    class="text-danger">*</span></label>
                            <input wire:model.live="detail.phone_number" type="text" class="form-control"
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            <label for="national_id" class="form-label">National ID<span
                                    class="text-danger">*</span></label>
                            <input wire:model.live="detail.national_id" type="number" class="form-control"
                    ...
                    <div class="col-md-8 col-12">
                        <div class="mb-3">
                            ...
                            <input type="file" class="form-control" name="photo" wire:model.live="photo" id="photo">
                            @error('photo')
                ...
                <div class="row mt-5">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            <label for="dpt_id" class="form-label">Department<span
                                    class="text-danger">*</span></label>
                            <select wire:model.live="dpt_id" class="form-control" name="dpt_id" id="dpt_id">
                    ...
                    <div class="col-md-6 col-12">
                        <div class="mb-3">
                            <label for="dpt_id" class="form-label">Designation<span
                                    class="text-danger">*</span></label>
                            <select wire:model.live="detail.designation_id" class="form-control" name="dpt_id"
                                id="dpt_id">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            <label for="marital_status" class="form-label">Marital Status<span
                                    class="text-danger">*</span></label>
                            <select wire:model.live="detail.marital_status" class="form-control" name="marital_status"
                                id="marital_status">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            <label for="birth_date" class="form-label">Birth Date<span
                                    class="text-danger">*</span></label>
                            <input wire:model.live="detail.birth_date" type="date" class="form-control"
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            ...
                            <select wire:model.live="detail.gender" class="form-control" name="gender" id="gender">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea wire:model.live="detail.physical_address" placeholder="Enter your Physical Address" class="form-control"
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            <label for="kra_pin" class="form-label">KRA PIN<span
                                    class="text-danger">*</span></label>
                            <input wire:model.live="detail.kra_pin" type="text" class="form-control" name="kra_pin"
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            <label for="nssf" class="form-label">NSSF Identifier<span
                                    class="text-danger">*</span></label>
                            <input wire:model.live="detail.nssf" type="text" class="form-control" name="nssf"
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            <label for="nhif" class="form-label">NHIF Identifier<span
                                    class="text-danger">*</span></label>
                            <input wire:model.live="detail.nhif" type="text" class="form-control" name="nhif"
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <textarea wire:model.live="detail.handicap" placeholder="Enter the Description of Your Handicap" class="form-control"
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            ...
                            <input wire:model.live="kra_file" type="file" class="form-control" name="kra_file"
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            ...
                            <input wire:model.live="nssf_file" type="file" class="form-control" name="nssf_file"
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            ...
                            <input wire:model.live="nhif_file" type="file" class="form-control" name="nhif_file"
                ...
                <div class="row mt-3">
                    ...
                    <div class="col-md-4 col-6">
                        <div class="mb-3">
                            ...
                            <select wire:model.live="account.bank_id" class="form-control" name="bank_id"
                                id="bank_id">
