                    ...
                    <table class="table">
                        <thead>
                            <tr>
                                ...
                                <th>Designation</th>
                                <th>Contract Type</th>
                                <th class="text-center">Contract(s)</th>
                                <th>Days Worked</th>
                                <th>Days on Leave</th>
                                <th>Days Absent <span class="text-danger">(-)</span></th>
                                <th>Total Gross Pay</th>
                                <th>NSSF Contribution <span class="text-danger">(-)</span></th>
                                <th>PAYE <span class="text-danger">(-)</span></th>
                                @if ($payroll->monthlySalaries)
                                @endif
                                <th>NHIF Premium <span class="text-danger">(-)</span></th>
                                <th>SHA Premium <span class="text-danger">(-)</span></th>
                                <th>NITA <span class="text-danger">(-)</span></th>
                                <th>Housing Levy<span class="text-danger">(-)</span></th>
                                <th>Overtimes<span class="text-success">(+)</span></th>
                                <th>Bonuses<span class="text-success">(+)</span></th>
                                <th>Fines <span class="text-danger">(-)</span></th>
                                <th>Loan Repayment <span class="text-danger">(-)</span></th>
                                <th>Welfare Contributions <span class="text-danger">(-)</span></th>
                                <th>Additions <span class="text-success">(+)</span></th>
                                <th>Deductions <span class="text-success">(+)</span></th>
                                <th>Net Pay</th>
                        ...
                        <tfoot>
                            <tr>
                                ...
                                <td class="text-success"><strong>KES {{ number_format($total_bonuses, 2) }}</strong>
                                </td>
