                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model='security_guard.first_name' class="form-control" name=""
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="text" wire:model='security_guard.last_name' class="form-control" name=""
                    ...
                    <div class="col-md-6">
                        <div class="mb-3">
                            ...
                            <input type="email" wire:model='security_guard.email' class="form-control" name=""
