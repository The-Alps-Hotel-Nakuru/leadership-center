                ...
                <div class="row">
                    <div class="col-md-8 col-12">
                        <div class="mb-3">
                            ...
                            <input wire:model="asset_subcategory.title" type="text" class="form-control"
                                name="asset_subcategory.title" id="asset_subcategory.title" aria-describedby="title"
                                placeholder="Enter the Title of your Subcategory">
                    ...
                    <div class="col-12">
                        <div class="mb-3">
                            ...
                            <select wire:model="asset_subcategory.asset_category_id" class="form-control"
