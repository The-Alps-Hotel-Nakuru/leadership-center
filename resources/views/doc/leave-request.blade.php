...
<head>
    <title>Leave Request Notification - {{ env('COMPANY_NAME') }}</title>
    <style>
...
<body>
    <div class="container">
        ...
        <p>Dear Admin,</p>
        <p>This is to inform you that {{ $leaveRequest->employee->user->name }} has requested for leave. Below are the details of the leave request:</p>
        ...
        <p>Please review the request at your earliest convenience. You can take the necessary action by logging into the admin portal.</p>
