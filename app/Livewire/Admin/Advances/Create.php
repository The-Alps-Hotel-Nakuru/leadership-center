...
class Create extends Component
{
    ...
    public function save()
    {
        ...
        $log->payload = "<strong>" . auth()->user()->name . "</strong> has added a advance for <strong>" . $this->advance->employee->user->name . ' on ' . Carbon::parse($this->advance->created_at)->format('j F, Y - h:i A') . "</strong> amounting to <strong>KES " . number_format($this->advance->amount_kes, 2) . "</strong> in the system";
        $log->save();
